...
export var Print = /** @class */ (function () {
    ...
    Print.error = function (message, style) {
        console.error.apply(console, this.styleMessage(message, __assign({ context: "warn" }, style)));
    };
    Print.info = function (message, style) {
        console.log.apply(console, this.styleMessage(message, __assign({ context: "info" }, style)));
    };
    Print.success = function (message, style) {
        console.log.apply(console, this.styleMessage(message, __assign({ context: "success" }, style)));
    };
    Print.palette = {
        reset: "\x1b[0m",
        warn: {
